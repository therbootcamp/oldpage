...
- It is difficult to share common 
...
- In this introduction, we'll introduce the basic building blocks of creating plots with ggplot2 by creatingn the following plot from the ground-up:
