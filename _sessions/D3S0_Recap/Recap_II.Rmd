...
<font size = 5> dplyr makes extensive use of the 'pipe' %>% which passes objects between functions</font>
...
> <font size = 5>How can I write readable, well-formatted code?<font>

## Plotting 1.0

> <font size = 5>How can I easily create publication--ready plots?<font>

## Plotting 2.0

> <font size = 5>Can I make interactive websites with R?<font>
