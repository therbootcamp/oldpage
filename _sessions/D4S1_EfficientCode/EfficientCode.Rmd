...
In other words, **don't use loops**, stay away from all **apply idoms**, such as `apply()`, `sapply()`, `tapply()`, etc., and use functions that have been implemented in C/C++. 
]
...
# define function
my_Rcpp_fun = "
NumericVector colMeans_c(NumericMatrix& mat) {
...
# microbenchmark
microbenchmark(vectorz = colMeans(as.data.frame(my_data)),
