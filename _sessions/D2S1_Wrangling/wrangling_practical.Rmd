...
27. Separately for all combinations of gender and race, calculate the mean age and mean CD4 T cell count at baseline (`cd40`) (Hint: group by `gender` and `race`)
...
31. In one block of code, complete the following tasks
    ...
    - For each group calculate the mean age, percentagey of patients that are male, and mean number of days until a major negative event.
