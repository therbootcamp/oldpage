...
knitr::include_graphics("../_image/dplyr_hex.png")
```
...
knitr::include_graphics("../_image/data_wrangling_ss.png")
```
...
knitr::include_graphics("../_image/pipe.jpg")
```
...
```{r, echo = FALSE, out.width = "70%", fig.align = 'center'}
knitr::include_graphics("../_image/sequential.png")
```
...
```{r, echo = FALSE, out.width = "70%", fig.align = 'center'}
knitr::include_graphics("../_image/tidyr_hex.png")
```
]
...
knitr::include_graphics("../_image/gather_ss.png")
```
]
...
```{r, echo = FALSE, out.width = "80%", fig.align = 'center'}
knitr::include_graphics("../_image/spread_ss.png")
```
