...
- There are dozens functions in dplyr that allow you to wrangle data.

- For an overview, look at the cheatsheet.

- We will now show you how to use ~10 of the most common ones
