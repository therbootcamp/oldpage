...
knitr::include_graphics("../_image/mldiagram_A.png")
```
...
knitr::include_graphics("../_image/machinelearningcartoon.png")
```
...
knitr::include_graphics("../_image/mlexamples.png")
```
...
knitr::include_graphics("../_image/MLdiagram.png")
```
...
knitr::include_graphics("../_image/stockpen.jpg")
```
...
knitr::include_graphics("../_image/bohr.jpg")
```
...
```{r, echo = FALSE, out.width = "70%", fig.align = 'center'}
knitr::include_graphics("../_image/fittingpredictiondarts_A.png")
```

---
# Training (fitting) vs. Testing (prediction)
```{r, echo = FALSE, out.width = "70%", fig.align = 'center'}
knitr::include_graphics("../_image/fittingpredictiondarts_B.png")
```

---
# Training (fitting) vs. Testing (prediction)
```{r, echo = FALSE, out.width = "70%", fig.align = 'center'}
knitr::include_graphics("../_image/fittingpredictiondarts_C.png")
```

---
# Training (fitting) vs. Testing (prediction)
```{r, echo = FALSE, out.width = "70%", fig.align = 'center'}
knitr::include_graphics("../_image/fittingpredictiondarts_D.png")
```
...
knitr::include_graphics("../_image/wikipediaml.png")
```
...
knitr::include_graphics("../_image/regression.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../_image/defaulttree.png")
```
...
knitr::include_graphics("../_image/supportvectormachine.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics("../_image/randomforest.png")
```
...
knitr::include_graphics("../_image/mlrcaret.png")
```
