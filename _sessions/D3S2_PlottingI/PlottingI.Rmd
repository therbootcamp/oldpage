...
```{r, echo = FALSE, out.width="100%", fig.align = 'center'}
knitr::include_graphics("https://raw.githubusercontent.com/therbootcamp/therbootcamp.github.io/master/_sessions/_image/complexplot2.png")
```
]
...
<font size =5>Add a blue smoothed line</font>
...
ggplot(data = mpg,
       mapping = aes(x = displ, y = hwy)) +
  geom_point() +
  theme(panel.grid.major.y = ..., # Major gridline
        # Gridline width
        # Plot margin spacing)
```


<font size = 5>To see all of the arguments, look at the help menu or check out the ggplot2.tidyverse.org
