...
```{r, out.width= "75%", fig.width = 6, fig.height = 4}
ggplot(data = mpg,
...
```{r, out.width= "60%", echo = TRUE, fig.width = 6, fig.height = 4}
...
- We have only touched the surface of what you can do with `ggplot2`
