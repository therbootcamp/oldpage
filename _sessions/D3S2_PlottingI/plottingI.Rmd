...
knitr::include_graphics("../_image/ggplotgallery.png")
```
...
knitr::include_graphics("../_image/complexplot1.png")
```

```{r, echo = FALSE, out.width="100%", fig.align = 'center'}
knitr::include_graphics("../_image/complexplot2.png")
```
]
...
```{r, echo = FALSE, out.width="60%", fig.align = 'center'}
knitr::include_graphics("../_image/wilkonson_book.png")
```
...
knitr::include_graphics("../_image/wickham_portrait.png")
```
...
```{r, echo = FALSE, out.width="60%", fig.align = 'center'}
knitr::include_graphics("../_image/ggplot_hex.png")
```
...
knitr::include_graphics("../_image/carlot.jpg")
```
...
```{r, echo = FALSE, out.width="80%", fig.align = 'center'}
knitr::include_graphics("../_image/plotting_books.png")
```
