...
1. Below you see some 'dirty' code. Go through it and clean it according to the above principles (incl. commenting). Then download all of the data files referenced in the code, store them in `1_data`, and change the filepaths in the code to this location. When ready save the code in the `2_code` folder as `cleaned_code_2018Jan27.R`.
