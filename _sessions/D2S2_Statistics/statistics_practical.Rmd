...
5. Do heavier people tend to have fewer days until a major negative event? Conduct a correlation test between weight (`wtkg`) and age (`days`). What is your conclusion?
...
7. Only considering men, is there a correlation between CD4 T cell count at baseline (`cd40`)and CD8 T cell count at baseline (`cd80`)?
...
8. Now, repeat the previous test, but only for women. Do you get the same or different results?
