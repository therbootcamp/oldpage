...
knitr::include_graphics("../_image/whatisshiny.png")
```
...
```{r, echo = FALSE, fig.align = 'center', fig.cap = 'Source: http://shiny.rstudio.com/../_image/shiny-cheatsheet.pdf', out.width = "95%"}
knitr::include_graphics("../_image/shiny_definition.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/nohtml.png")
```
...
knitr::include_graphics("../_image/shiny_ss.png")
```
...
knitr::include_graphics("../_image/whatyoucando.png")
```
...
knitr::include_graphics("../_image/learnshiny_B.png")
```
...
knitr::include_graphics("../_image/shinygallery.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/shinyprogramming_ss.png")
```
...
knitr::include_graphics("../_image/uiandserver.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_A.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_B.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_C.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_D.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_E.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_F.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_G.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/exampleapp_H.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "80%"}
knitr::include_graphics("../_image/userinterface_description.png")
```
...
knitr::include_graphics("../_image/widgetcode_output.png")
```
...
knitr::include_graphics("../_image/shinylayouts.png")
```
...
knitr::include_graphics("../_image/serverdescription.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics("../_image/render_example.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics("../_image/rendering_output.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = "100%", fig.cap = "http://shiny.rstudio.com"}
knitr::include_graphics("../_image/shinypublish.png")
```
